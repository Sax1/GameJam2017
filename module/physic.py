...
def isLanded(j,elem):
    ...
    if(elem.get_pos()[0]<=midBottomJoueur[0] and elem.get_pos()[0]+elem.get_img().get_width() >= midBottomJoueur[0] and elem.get_pos()[1] <= midBottomJoueur[1] and elem.get_pos()[1]+elem.get_img().get_width() >= midBottomJoueur[1]):
        return 1;
    else:
        return 0;
